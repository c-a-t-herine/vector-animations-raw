...
EXPORT_ICON = os.path.join(PREVIEW_SELECTOR_UI_ICONS_DIR, "../CozmoUI/coz_export2Robot.png")
...
from PySide6.QtWidgets import QMenu, QApplication, QCheckBox, QLineEdit, QMessageBox, QComboBox, QPushButton, QWidget, QVBoxLayout, QScrollArea, QLabel, QHBoxLayout
...
class PreviewSettings(QWidget):
    ...
    def layoutTopRow(self):
        ...
        publishButton = self.createSelectorButton(iconImg=EXPORT_ICON,
                                                  tooltip="Export animation",
                                                  callback=self.openExporter)
    ...
    def openMacClient(self):
        MacClientDialog(self, MacClientMode.MAC_CLIENT)

    def connectToWifi(self):
        MacClientDialog(self, MacClientMode.WIFI)

    def otaVectorToLatest(self):
        MacClientDialog(self, MacClientMode.OTA)
